...
void createImage(int* image, int width, int height, int index)
{
	...
	MyNewImage.Save("D:/3rd year second term/HPC/HPC_ProjectTemplate/HPC_ProjectTemplate/res" + index + ".png");
...
int main()
{
	...
	img = "D:/3rd year second term/HPC/HPC_ProjectTemplate/HPC_ProjectTemplate/Debug/test.png";
